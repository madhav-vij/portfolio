...
const brands = [
  ...
  { name: "Counsel India",              logo: img("/images/counselindia-new.png"),                          whiteBg: false },
  { name: "Upskill Lab",                logo: img("/images/upskilllogo.jpg"),                                whiteBg: true },
  { name: "Social Banana",              logo: img("/images/socialbanana-new.png"),                           whiteBg: false },
      ...
      <section id="brands" className="relative py-24 overflow-hidden" style={{ background: "#030712" }}>
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 mb-12">
          <motion.div {...fadeUp(0)}>
            ...
            <p className="text-slate-500 text-base">Worked across Real Estate, EdTech, Fashion, FinTech, FMCG, Food & Beverage, and other diverse industries.</p>
          </motion.div>
        </div>
