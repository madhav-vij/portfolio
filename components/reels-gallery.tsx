...
const heroReel = {
  ...
  companyLogo: img("/images/counselindia-new.png"),
  views: "30.4M",
...
const gridReels = [
  ...
  },
  {
    ...
    companyLogo: img("/images/socialbanana-new.png"),
    views: "3.6M",
  ...
  },
  {
    ...
    company: "BOP Realty",
    companyLogo: img("/images/boplog.jpg"),
    views: "1.6M",
...
function CompanyBadge({ logo, name, dark = false }: { logo: string; name: string; dark?: boolean }) {
  return (
    <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-full"
      style={{
        background: dark ? "rgba(0,0,0,0.75)" : "rgba(255,255,255,0.12)",
        border: dark ? "1px solid rgba(255,255,255,0.15)" : "1px solid rgba(255,255,255,0.2)",
        backdropFilter: "blur(12px)",
      }}>
      <div className="w-4 h-4 rounded-full overflow-hidden flex-shrink-0 bg-white flex items-center justify-center">
        <Image src={logo} alt={name} width={16} height={16} className="object-contain w-full h-full" />
      </div>
      <span className="text-[9px] font-bold uppercase tracking-wider text-white whitespace-nowrap">{name}</span>
    </div>
  )
}
...
function ViewsBadge({ views }: { views: string }) {
  return (
    <div className="flex items-center gap-1 px-2.5 py-1 rounded-full"
      ...
      <span className="text-[9px] font-bold text-white tracking-wide">{views}</span>
    </div>
  )
}
            ...
            <div className="flex flex-col md:grid md:grid-cols-[280px_1fr]">
              ...
              <div className="relative overflow-hidden" style={{ minHeight: 320 }}>
                ...
                <div className="absolute top-4 left-4 z-20">
                  <CompanyBadge logo={heroReel.companyLogo} name={heroReel.company} />
                </div>
                {/* Views badge bottom-left */}
                <div className="absolute bottom-4 left-4 z-20">
                  <ViewsBadge views={heroReel.views} />
                </div>
              </div>
            ...
            {gridReels.map((reel, i) => (
              ...
              >
                ...
                <div className="relative overflow-hidden" style={{ aspectRatio: "9/13" }}>
                  ...
                  {/* Gradient overlays */}
                  <div className="absolute inset-0" style={{ background: "linear-gradient(to top,rgba(13,13,18,0.95) 0%,rgba(13,13,18,0.3) 50%,transparent 100%)" }} />
                  ...
                  <div className="absolute top-3 left-3 z-20">
                    <CompanyBadge logo={reel.companyLogo} name={reel.company} dark />
                  </div>

                  {/* Views badge — top right */}
                  <div className="absolute top-3 right-3 z-20">
                    <ViewsBadge views={reel.views} />
                  </div>

                  {/* Description overlay at bottom */}
                  <div className="absolute bottom-0 left-0 right-0 p-4 z-20">
                    <p className="text-white text-xs font-medium leading-snug line-clamp-2">{reel.desc}</p>
                  </div>
                </div>
                ...
                <div className="p-4">
                  ...
                  <p className="text-[9px] font-bold uppercase tracking-widest mb-1" style={{ color: "#a78bfa" }}>Why it worked</p>
        ...
        <div className="relative max-w-6xl mx-auto px-5 sm:px-8 lg:px-10">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 mb-3">
              <div className="w-12 h-12 rounded-xl overflow-hidden shadow-lg flex-shrink-0"
                ...
                <Image src={img("/images/socialbanana-new.png")} alt="Social Banana" width={48} height={48} className="object-cover w-full h-full" />
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <a
                href="https://www.instagram.com/socialbananaaa/"
                target="_blank"
